    ...
    <div className="p-4">
      ...
      <div className="mb-6 p-4 border rounded">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Quantity Sent</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Sample Sent To</label>
            <input
              type="text"
